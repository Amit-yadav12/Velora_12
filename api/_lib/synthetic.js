...
export const CATS = [
  ...
  C('Diagnostic Centers', '07:00', '21:00', '/biz/diagnostic.jpg', ['Thyro Labs', 'Lal Labs', 'Metropolis Labs', 'Lucid Labs', 'Vijaya Labs'], ['Diagnostics', 'Pathology Labs', 'Diagnostic Centre'], ['Phlebotomist', 'Lab Technician', 'Pathologist'], [['Blood Test Panel', 'CBC + sugar + lipid', 15, 399, 1299], ['Thyroid Profile', 'T3 T4 TSH complete', 15, 450, 950], ['Full Body Package', '75+ tests + free consult', 30, 1499, 3999], ['Home Sample Collection', 'Doorstep pickup', 20, 0, 150]]),
  C('Pharmacies', '08:00', '23:00', '/biz/pharmacy.jpg', ['MedPlus', 'Apollo Med', 'Wellness', 'Care Med'], ['Pharmacy', 'Medical Store', 'Health Pharmacy'], ['Pharmacist', 'Store Manager'], [['Prescription Order', 'Upload & get medicines', 10, 99, 999], ['BP Check', 'Free BP monitoring', 5, 0, 50], ['Sugar Check', 'Glucometer test', 5, 30, 80]]),
  ...
  C('Beauty Clinics', '10:00', '20:00', '/biz/beauty.jpg', ['Kaya', 'VLCC', 'DermaGlow', 'SkinQ', 'GlowLab', 'Aesthetica'], ['Skin Clinic', 'Aesthetic Centre', 'Derma Clinic'], ['Dermatologist', 'Aesthetician', 'Laser Specialist'], [['Skin Consultation', 'Analysis + treatment plan', 30, 500, 1000], ['HydraFacial', 'Deep cleanse + glow', 60, 2500, 6000], ['Laser Hair Reduction', 'Full body sessions', 60, 4999, 24999], ['Chemical Peel', 'Pigmentation & acne', 45, 2000, 5500]]),
  ...
  C('Yoga Studios', '05:00', '21:00', '/biz/yoga.jpg', ['YogaMantra', 'Pranayama', 'Asana House', 'OmShala', 'Yogalaya', 'Sattva'], ['Yoga Studio', 'Yoga Shala', 'Yoga & Meditation'], ['Yoga Acharya', 'Meditation Guide'], [['Drop-in Class', 'Hatha / Vinyasa flow', 60, 250, 500], ['Monthly Batch', '12 sessions + diet chart', 60, 1800, 3500], ['Meditation Session', 'Guided mindfulness', 45, 300, 700], ['Therapy Yoga', 'Back pain / PCOS care', 60, 800, 1500]]),
  ...
  C('Restaurants', '11:00', '23:00', '/biz/restaurant.jpg', ['SpiceSymphony', 'Tandoori Nights', 'Dakshin Feast', 'Royal Dine', 'Biryani House'], ['Restaurant', 'Fine Dine', 'Family Restaurant', 'Multi-Cuisine'], ['Head Chef', 'Captain'], [['Table for 2', 'Window / regular seating', 90, 0, 0], ['Buffet Lunch', 'Unlimited multi-cuisine', 120, 549, 1299], ['Buffet Dinner', 'Live grill + desserts', 150, 749, 1699], ['Private Dining', 'Celebration room', 180, 2000, 5000]]),
  C('Cafés', '09:00', '23:00', '/biz/cafe.jpg', ['Cafe Aaranya', 'BrewRoom', 'Filter Kaapi House', 'Mocha Tales', 'BeanBarn'], ['Café', 'Coffee House', 'Espresso Bar'], ['Barista', 'Pastry Chef'], [['Table Booking', 'Indoor / outdoor seat', 120, 0, 0], ['Brewing Workshop', 'Pour-over masterclass', 90, 999, 1999], ['High Tea for 2', 'Snacks + beverages', 120, 799, 1499]]),
  ...
  C('Coworking Spaces', '08:00', '22:00', '/biz/coworking.jpg', ['WorkNest', 'HustleHub', 'DeskDweller', 'Startup Bay', 'Focus Labs'], ['Coworking', 'Workspaces', 'Business Centre'], ['Community Manager', 'Facility Lead'], [['Day Pass', 'Hot desk + wifi + coffee', 600, 399, 899], ['Hot Desk Monthly', 'Flexible seating', 30, 4999, 9999], ['Meeting Room / Hour', '6-seater + screen', 60, 500, 1200]]),
  ...
  C('Cricket Turfs', '06:00', '23:00', '/biz/cricket.jpg', ['TurfTown', 'CricArena', 'SixerPark', 'WicketWorld', 'PowerPlay Turf'], ['Cricket Turf', 'Box Cricket', 'Turf Arena'], ['Turf Manager', 'Coach'], [['Turf Slot / Hour', '6-a-side with equipment', 60, 1200, 3500], ['Night Slot / Hour', 'Floodlit premium hours', 60, 1800, 4500], ['Tournament (Team)', 'Weekend cup', 240, 3000, 8000]]),
  C('Football Grounds', '06:00', '22:00', '/biz/football.jpg', ['GoalArena', 'KickOff', 'StrikerPark', 'GoalLine', 'HatTrick'], ['Football Ground', 'Soccer Turf', 'Football Arena'], ['Ground Manager', 'Football Coach'], [['Ground Slot / Hour', '5-a-side / 7-a-side', 60, 1500, 4000], ['Kids Academy Trial', 'Age 5-15 batches', 60, 300, 600], ['Monthly Academy', '12 coached sessions', 60, 2500, 5000]]),
  ...
  C('Swimming Pools', '06:00', '21:00', '/biz/swimming.jpg', ['AquaSplash', 'BlueWave', 'SwimFit', 'CrystalPool', 'SplashPoint'], ['Swimming Pool', 'Swim Academy', 'Aquatic Centre'], ['Swim Coach', 'Lifeguard'], [['Open Swim / Hour', 'Lap + leisure lanes', 60, 200, 500], ['Learn to Swim (12)', 'Beginner batch', 60, 3000, 7000], ['Aqua Aerobics', 'Low-impact fitness', 45, 400, 800]]),
  ...
  C('Banks', '10:00', '16:00', '/biz/bank.jpg', ['City Bank Branch', 'Metro Bank', 'National Bank Branch'], ['Branch', 'Bank & Locker Desk'], ['Branch Manager', 'Relationship Manager'], [['Account Opening', 'Savings / current / salary', 30, 0, 0], ['Loan Consultation', 'Home / personal / auto', 45, 0, 0], ['Locker Visit', 'Safe deposit access', 15, 0, 0]]),
  C('Insurance Offices', '10:00', '18:00', '/biz/insurance.jpg', ['PolicyDesk', 'CoverSure', 'InsureFirst', 'SafeGuard Advisors'], ['Insurance', 'Insurance Advisors'], ['Insurance Advisor', 'Claims Specialist'], [['Health Insurance Plan', 'Family floater quotes', 45, 0, 0], ['Motor Insurance', 'Car / bike renewal', 20, 0, 0], ['Claim Filing Help', 'Cashless + reimbursement', 30, 0, 0]]),
  ...
  C('Pet Clinics', '09:00', '21:00', '/biz/pet.jpg', ['Paws & Claws', 'HappyTails', 'VetCare Plus', 'FurryFriends', 'Pawfect Care'], ['Pet Clinic', 'Veterinary Clinic', 'Pet Care Centre'], ['Veterinarian', 'Vet Assistant'], [['Vet Consultation', 'General health check', 20, 400, 800], ['Vaccination', 'ARV / DHPPi / FVRCP', 15, 400, 1800], ['Pet Grooming', 'Bath + cut + nails', 90, 800, 2500]]),
  ...
  C('Bike Rentals', '08:00', '22:00', '/biz/bike.jpg', ['BikeBlitz', 'ThrottleRent', 'RoadRider Rentals', 'RideReady'], ['Bike Rentals', 'Motorcycle Rentals', 'Scooter Rentals'], ['Fleet Executive', 'Mechanic'], [['Scooter / Day', 'Activa / Ntorq', 1440, 500, 900], ['Royal Enfield / Day', 'Classic 350', 1440, 1500, 2500], ['Sport Bike / Day', 'KTM / R15 / Apache', 1440, 1800, 3500]]),
  C('Car Service Centers', '09:00', '20:00', '/biz/car-service.jpg', ['CarClinic', 'AutoMend', 'MotorWorks', 'FixMyCar', 'ServiceLane'], ['Car Service', 'Auto Garage', 'Car Care Studio'], ['Service Advisor', 'Master Technician'], [['General Service', 'Oil + filters + checkup', 240, 2499, 7999], ['Car Detailing', 'Interior + exterior spa', 300, 1999, 8999], ['AC Repair & Gas', 'Cooling + leak check', 120, 1499, 4999], ['Wheel Alignment', 'Balancing + rotation', 60, 800, 2000]]),
  ...
  C('Event Venues', '09:00', '22:00', '/biz/event.jpg', ['GrandCelebrations', 'VenueVault', 'PartyPalace', 'BanquetBliss'], ['Banquets', 'Convention Centre', 'Party Lawns'], ['Venue Manager', 'Event Planner'], [['Banquet (100 guests)', '4-hour slot + basics', 240, 40000, 120000], ['Lawn (300 guests)', 'Evening wedding slot', 300, 90000, 250000], ['Conference Hall', 'Corporate day package', 480, 25000, 80000]]),
  C('Photography Studios', '09:00', '21:00', '/biz/photography.jpg', ['PixelPerfect', 'CandidTales', 'ShutterSoul', 'FrameCraft'], ['Photography', 'Photo Studio', 'Candid Studio'], ['Lead Photographer', 'Cinematographer'], [['Portrait Session', '1-hour studio shoot', 60, 2500, 8000], ['Pre-wedding Shoot', '2 locations + teaser', 480, 25000, 80000], ['Wedding Day', 'Photo + video team', 600, 60000, 200000]]),
  C('Travel Agencies', '10:00', '20:00', '/biz/travel.jpg', ['WanderLust Trips', 'YatraMitra', 'GlobeTrek', 'SafarSathi'], ['Travels', 'Holidays', 'Tours & Travels'], ['Travel Consultant', 'Visa Expert'], [['Flight Booking', 'Best-fare promise', 30, 0, 0], ['Holiday Package (3N)', 'Goa / Kerala / Dubai', 60, 15000, 90000], ['Visa Filing', 'Schengen / US / UK', 45, 2000, 8000]]),
];
  ...
  if (!all) {
    ...
    for (let catIdx = 0; catIdx < CATS.length; catIdx++) {
      ...
      for (let idx = 0; idx < PER_CAT_PER_CITY; idx++) {
        ...
        // Production: real category photos from /biz/, zero placeholder-image.
